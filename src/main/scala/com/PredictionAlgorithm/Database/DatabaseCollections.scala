...
final case object POINT_TO_POINT_COLLECTION extends DatabaseCollections {
  ...
  val DAY_DURATIONS = "DAY_DURATIONS"
  ...
  override val fieldsVector = Vector(ROUTE_ID, DIRECTION_ID, FROM_POINT_ID, TO_POINT_ID, DAY_DURATIONS, TIME_OFFSET, DURATION, LAST_UPDATED)
  override val indexKeyList = List((ROUTE_ID, 1),(DIRECTION_ID, 1),(FROM_POINT_ID, 1),(TO_POINT_ID, 1))
